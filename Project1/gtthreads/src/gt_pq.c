...
{	//printf("\nEntering __add_to_runqueue in file gt_pq\n");
...
{	//printf("\nEntering __rem_from_runqueue in file gt_pq\n");
	unsigned int uprio, ugroup;
	uthread_head_t *uhead;
...
{	printf("\nEntering init_runqueue in file gt_pq\n");
	uthread_head_t *uhead;
	int i, j;
...
{	//printf("\nEntering add_to_runqueue in file gt_pq\n");
...
{	//printf("\nEntering rem_from_runqueue in file gt_pq\n");
	gt_spin_lock(runq_lock);
...
{	//printf("\nEntering switch_runqueue in file gt_pq\n");
...
{	//printf("\nEntering kthread_init_runqueue in file gt_pq\n");
...
{	//printf("\nEntering *sched_find_best_uthread in file gt_pq\n");
	...
	kthread_runq->kthread_runqlock.holder = 0x04; //Running flag
...
{	//printf("\nEntering *sched_find_best_uthread_group in file gt_pq\n");
